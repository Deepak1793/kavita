...
public class LoggingAspect {
	...
	private Log log = LogFactory.getLog(getClass());
	 ...
	 @Before("execution(* com.example.demo.controller.RecommendController.*(..))")
	    public void logBefore(JoinPoint point) {
	        log.info(point.getSignature().getName() + " before called...");
	    }
	 
	 @After("execution(* com.example.demo.controller.RecommendController.*(..))")
	    public void logAfter(JoinPoint point) {
	        log.info(point.getSignature().getName() + " after called...");
	    }
	 
	 @AfterReturning("execution(* com.example.demo.controller.RecommendController.*(..))")
	    public void logAfterReturning(JoinPoint point) {
	        log.info(point.getSignature().getName() + " after returning called...");
	    }
	 
	 @AfterThrowing("execution(* com.example.demo.controller.RecommendController.*(..))")
